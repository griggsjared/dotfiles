...
function M.get(c, _)
	local spec = {
		["@annotation"] = { fg = c.base.cyan, italic = false },
		...
		["@keyword.function"] = { fg = c.base.cyan, italic = false, bold = true },
		...
		["@keyword.type"] = { fg = c.base.cyan, italic = true, bold = true },
		...
		["@keyword.cpp"] = { fg = c.base.cyan, italic = false },
