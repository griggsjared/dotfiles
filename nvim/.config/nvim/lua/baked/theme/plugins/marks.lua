...
function M.get(c, _)
	return {
		MarkSignHL = { fg = c.base.cyan, bold = true },
		MarkSignNumHL = { fg = c.base.cyan },
		MarkVirtTextHL = { fg = c.base.dimmed3, italic = true },
		MarkVirtTextHLa = { fg = c.base.green },
		MarkVirtTextHLb = { fg = c.base.cyan },
		...
		MarkSignHLh = { fg = c.base.cyan, bold = true },
