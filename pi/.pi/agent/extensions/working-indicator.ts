...
const TOOL_WORDS: Record<string, string[]> = {
	...
	web_explore: [
		"Researching", "Exploring", "Investigating", "Cross-checking", "Interrogating", "Digging",
		"Searching", "Querying", "Scraping", "Crawling", "Trawling", "Netting",
		"Fishing", "Angling", "Chasing", "Sourcing", "Verifying", "Validating",
		"Corroborating", "Triangulating", "Fact-checking", "Sleuthing", "Scouting", "Monitoring",
		"Mining", "Sampling", "Comparing", "Contrasting", "Ranking",
		"Googling", "Surfing", "Tab-hopping", "Link-hopping", "Hopping", "Lurking",
		"Creeping", "Spidering", "Harvesting", "Panning",
		"Rating", "Fact-finding", "Confirming", "Interviewing", "Asking", "Inquiring",
		"Detecting", "Discovering", "Zooming in", "Narrowing down",
	],
	subagent: [
