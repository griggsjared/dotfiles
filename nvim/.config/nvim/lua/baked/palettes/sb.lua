-- Starbase (BisectHosting) theme palette
...
local palette = {
    ...
    -- Theme-specific ANSI colors (BisectHosting brand colors)
    red = "#d395d0",       -- Pink-purple gradient
    orange = "#04da8d",    -- Bright teal accent
    yellow = "#ffd866",    -- Golden yellow
